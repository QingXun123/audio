package com.qxbase.audio.config;
...
public class SwaggerConfig {
	...
	public Docket userApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				.groupName("用户模块")
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.qxbase.audio.server.user.controller"))
				.paths(PathSelectors.any())
				.build()
				.apiInfo(apiInfo());
	}
	...
	public Docket essayApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				.groupName("文章模块")
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.qxbase.audio.server.essay.controller"))
				.paths(PathSelectors.any())
				.build()
				.apiInfo(apiInfo());
	}
